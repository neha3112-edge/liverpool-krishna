                    ...
                    <div>
                      ...
                      <select name="course" class="form-control" id="courseSelect" required>
                            <option value="" selected disabled>Select Your Course</option>
                             		     <option value="DBA">MBA in Business Analytics </option>
                                     <option value="DBA">MBA in Finance</option>
                                      <option value="DBA">MBA in Marketing  </option>
                                      <option value="DBA">MBA in Leadership </option>
                                     <option value="DBA">MBA in Human Resources Management</option>
                                      <option value="DBA">MBA in Operation and Supply Chain Management</option>
